<template>
  <FstPageLayout title="GR-Панель" subtitle="Государственные отношения и регуляторный мониторинг">
    <template #actions>
...
<style scoped>
.gov-root { padding: 24px; display: flex; flex-direction: column; gap: 20px; min-height: 100vh; background: var(--surface-ground); }
.gov-header { display: flex; align-items: flex-start; justify-content: space-between; flex-wrap: wrap; gap: 12px; }
.gov-header h1 { margin: 0; font-size: 1rem; font-weight: 600; color: var(--p-text-color); }
.gov-subtitle { font-size: 0.8rem; color: var(--p-text-muted-color); }
...
.gov-btn.secondary{ background: var(--surface-card); color: var(--p-text-color); border: 1px solid var(--surface-border); }

.gov-kpi-row { display: grid; grid-template-columns: repeat(auto-fit, minmax(120px, 1fr)); gap: 12px; }
.gov-kpi { background: var(--surface-card); border: 1px solid var(--surface-border); border-radius: 10px; padding: 14px 12px; text-align: center; }
...
.radar-item { display: flex; align-items: flex-start; gap: 10px; padding: 10px; background: var(--surface-ground); border-radius: 8px; }
...
.contact-item { display: flex; align-items: center; gap: 10px; padding: 8px; background: var(--surface-ground); border-radius: 8px; }
...
.tl-item { display: grid; grid-template-columns: 90px 12px 1fr auto; align-items: flex-start; gap: 12px; padding: 10px 0; border-bottom: 1px solid var(--surface-border); }
...
.tl-tag   { font-size: 0.65rem; padding: 1px 6px; border-radius: 4px; background: var(--surface-ground); color: var(--p-text-muted-color); border: 1px solid var(--surface-border); }
...
.tl-status.planned  { background: var(--surface-ground); color: var(--p-text-muted-color); border: 1px solid var(--surface-border); }

.gov-table { width: 100%; border-collapse: collapse; font-size: 0.83rem; }
.gov-table th { padding: 7px 10px; text-align: left; color: var(--p-text-muted-color); border-bottom: 1px solid var(--surface-border); font-size: 0.75rem; }
.gov-table td { padding: 9px 10px; border-bottom: 1px solid var(--surface-border); color: var(--p-text-color); }
...
.modal-form input, .modal-form textarea, .modal-form select { background: var(--surface-ground); border: 1px solid var(--surface-border); border-radius: 6px; padding: 7px 10px; color: var(--p-text-color); font-size: 0.85rem; width: 100%; resize: vertical; }
