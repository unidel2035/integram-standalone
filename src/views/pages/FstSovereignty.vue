...
.sv-summary-bar { display: flex; align-items: center; gap: 20px; background: var(--p-surface-card); border: 1px solid var(--p-content-border-color); border-radius: 10px; padding: 16px 20px; flex-wrap: wrap; }
...
.dim-card { background: var(--p-surface-card); border: 1px solid var(--p-content-border-color); border-radius: 10px; padding: 14px; display: flex; flex-direction: column; gap: 10px; }
...
.sv-compliance, .sv-roadmap { background: var(--p-surface-card); border: 1px solid var(--p-content-border-color); border-radius: 10px; padding: 18px; }
...
.rm-step { display: flex; align-items: center; gap: 14px; background: var(--p-surface-ground); border: 1px solid var(--p-content-border-color); border-radius: 8px; padding: 12px; }
