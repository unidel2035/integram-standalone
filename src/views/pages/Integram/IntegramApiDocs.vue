<template>
  ...
  <span class="mcp-key">serverURL</span>: <span class="mcp-string">"https://ai2o.ru"</span>,
              ...
              <AccordionTab header="JavaScript/Vue">
                <div class="example-steps">
                  ...
                  <div class="example-step mb-4">
                    ...
                    <div class="js-code-block">
                      <div class="code-label">JavaScript:</div>
                      <pre class="js-code"><span class="js-keyword">await</span> integramApiClient.<span class="js-function">setServer</span>(<span class="js-string">'https://ai2o.ru'</span>)
...
const mcpTools = [
  // Auth
  {
    ...
    params: `serverURL — URL сервера (https://ai2o.ru)
