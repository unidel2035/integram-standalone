...
.np-header h1 { margin: 0; font-size: 1.5rem; color: var(--p-text-color); }
.np-sub { font-size: 0.85rem; color: var(--p-text-muted-color); }
.np-actions { display: flex; gap: 8px; }
.np-btn { padding: 8px 14px; border-radius: 8px; border: none; cursor: pointer; font-size: 0.83rem; font-weight: 600; }
