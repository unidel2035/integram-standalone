...
const modules = [
  ...
  },
  {
    id: 'administration',
    name: 'Бэк-офис фонда',
    phase: 'Фаза 5 — Управление фондом',
    icon: 'pi pi-wallet',
    color: '#ec4899',
    path: '/fst-administration',
    featured: true,
    status: 'live',
    desc: 'Управленческий учёт ФСБУ 4/2023: Management Fee, расходы фонда, Carried Interest, NAV, Capital Calls/Distributions, аудиторская поддержка, финотчётность.',
    tags: ['ФСБУ 4/2023', 'Management Fee', 'NAV', 'Carried Interest', 'Audit', 'GP', 'LP'],
  },
  {
    id: 'fund',
