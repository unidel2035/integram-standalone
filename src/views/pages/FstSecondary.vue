...
.sec-btn.secondary { background: var(--p-surface-card); color: var(--p-text-color); border: 1px solid var(--p-surface-border); }
.sec-btn.secondary:hover { background: var(--p-surface-hover); }
...
.sec-btn-sm.secondary { background: var(--p-surface-card); color: var(--p-text-color); border: 1px solid var(--p-surface-border); }

.sec-select { padding: 8px 12px; border-radius: 8px; border: 1px solid var(--p-surface-border); background: var(--p-surface-card); color: var(--p-text-color); font-size: 0.9rem; }
.sec-select-sm { padding: 6px 10px; border-radius: 6px; border: 1px solid var(--p-surface-border); background: var(--p-surface-card); color: var(--p-text-color); font-size: 0.85rem; }
.sec-input { padding: 8px 12px; border-radius: 8px; border: 1px solid var(--p-surface-border); background: var(--p-surface-card); color: var(--p-text-color); font-size: 0.9rem; width: 100%; }

/* Position Summary */
.sec-position { background: var(--p-content-background); border: 1px solid var(--p-surface-border); border-radius: 12px; padding: 24px; }
...
.sec-pos-card { display: flex; align-items: center; gap: 14px; background: var(--p-surface-ground); border: 1px solid var(--p-surface-border); border-radius: 10px; padding: 16px; }
...
.sec-tab { padding: 10px 18px; border-radius: 8px; border: 1px solid var(--p-surface-border); background: var(--p-surface-card); color: var(--p-text-muted-color); cursor: pointer; font-size: 0.9rem; display: flex; align-items: center; gap: 6px; white-space: nowrap; transition: all 0.2s; }
.sec-tab.active { background: var(--p-primary-color); color: #fff; border-color: var(--p-primary-color); }

/* Section */
.sec-section { background: var(--p-content-background); border: 1px solid var(--p-surface-border); border-radius: 12px; padding: 24px; }
...
.sec-val-method { background: var(--p-surface-ground); border: 2px solid var(--p-surface-border); border-radius: 12px; padding: 20px; cursor: pointer; transition: all 0.2s; }
...
.sec-val-result { background: var(--p-content-background); border-radius: 8px; padding: 12px; text-align: center; }
...
.sec-val-details { background: var(--p-surface-ground); border: 1px solid var(--p-surface-border); border-radius: 10px; padding: 20px; }
...
.sec-val-recommendation { display: flex; gap: 12px; padding: 14px; background: var(--p-content-background); border-radius: 8px; border-left: 3px solid var(--p-primary-color); font-size: 0.85rem; color: var(--p-text-color); line-height: 1.5; }
...
.sec-table th { padding: 10px 12px; text-align: left; color: var(--p-text-muted-color); border-bottom: 2px solid var(--p-surface-border); font-size: 0.75rem; font-weight: 600; text-transform: uppercase; }
.sec-table td { padding: 12px 12px; border-bottom: 1px solid var(--p-surface-border); color: var(--p-text-color); }
...
.sec-sum-card { background: var(--p-surface-ground); border: 1px solid var(--p-surface-border); border-radius: 8px; padding: 14px; display: flex; justify-content: space-between; align-items: center; }
...
.modal-footer { display: flex; gap: 10px; justify-content: flex-end; padding: 16px 24px; border-top: 1px solid var(--p-surface-border); }
...
.network-list li { padding: 8px 0; border-bottom: 1px solid var(--p-surface-border); font-size: 0.9rem; }
</style>
