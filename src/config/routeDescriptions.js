...
export const routeDescriptions = {
  ...
  '/fst-glossary': {
    description: 'ФСТ НТИ — Интерактивный глоссарий венчурных терминов с AI-объяснениями (Issue #110). Кликабельные термины по всему сайту через компонент <Term id="irr">IRR</Term> с подчёркиванием пунктиром. Модальное окно с 5 секциями: Определение (краткое объяснение термина), Формула/Расчёт (математическое представление), Пример (практический кейс из венчурной практики), Контекст ФСТ НТИ (применение в платформе), AI-объяснение (кнопка "Объяснить проще" → вызов /api/ai-tokens/chat с DeepSeek для простого объяснения без жаргона), Связанные термины (навигация между терминами). База из 30+ терминов по 3 категориям: Финансовые (IRR, MOIC, DPI, TVPI, NAV, Carried Interest, Waterfall, Hurdle Rate, Management Fee), Венчурные (Term Sheet, Due Diligence, Cap Table, SPV, LP, GP, Down Round, Pro-rata, Cliff, Vesting, SAFE, Convertible Note, Dilution, Option Pool), AI-специфичные (AI-инвесткомитет, Скрининг, Digital Twin, KAG, MCP, Investment Memo). Страница /fst-glossary с поиском, фильтрацией по категориям, grid-карточками терминов, статистикой (всего терминов, по категориям). Навигация между связанными терминами прямо в модальном окне. Доступ к глоссарию из меню "Обучение". Технологии: Vue 3 Composition API, PrimeVue Dialog/Chip/Button, DeepSeek для AI-объяснений, модульная архитектура (Term.vue + TermModal.vue + glossary.js data). Цель: снижение порога входа для начинающих венчурных инвесторов через контекстное обучение.',
    category: 'education',
    tags: ['ФСТ', 'НТИ', 'Глоссарий', 'Венчурные термины', 'AI-объяснения', 'DeepSeek', 'Обучение', 'IRR', 'MOIC', 'DPI', 'TVPI', 'NAV', 'Term Sheet', 'Due Diligence', 'Образование', 'Интерактив', 'Модал', 'Поиск', 'fund', 'Issue #110']
  },
  '/fst-benchmark': {
