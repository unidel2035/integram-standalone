...
const props = defineProps({
  ...
  // Issue #6934: Support icon-only mode for collapsed sidebar
  iconOnly: {
    type: Boolean,
    default: false
  }
...
const logoColor = computed(() => getCurrentColor.value || 'var(--p-primary-color, var(--primary-color))')
</script>

<template>
  <!-- Issue #6934: Icon-only mode for collapsed sidebar — DD icon -->
  <svg
    v-if="iconOnly"
    :width="width"
    :height="height"
  ...
  >
    <g transform="translate(0,200)">
      <path
        d="m 7.66,-85.12 c 13.07,-2.63 26.39,-4.2 39.76,-3.82 37.93,0.59 76.8,-2.76 113.8,7.51 32.38,12.14 61.48,34.5 79.6,64.16 27.24,49.05 26.69,113.85 -5.98,160.27 -19.18,26.35 -46.12,47.78 -77.61,57.28 -12.14,4.07 -24.74,7.3 -37.68,7 -37.43,-0.21 -74.85,0.21 -112.28,-0.59 -0.25,-18.03 -0.21,-36.07 -0.13,-54.06 33.14,-0.34 66.28,0.08 99.42,0.04 38.44,2.33 74.72,-23.34 90.97,-57.33 0.47,-2.21 1.32,-6.7 1.78,-8.95 6.11,-23.42 5.01,-49.94 -7.13,-71.37 -10.9,-20.58 -29.96,-35.94 -51.34,-44.68 -44.04,-8.36 -89.06,-1.74 -133.58,-4.58 0.38,-16.97 0.42,-33.95 0.38,-50.88 z"
        :fill="logoColor"
      />
      <path
        d="m 250.86,-88.92 c 13.07,-2.63 26.39,-4.2 39.76,-3.82 37.93,0.59 76.8,-2.76 113.8,7.51 32.38,12.14 61.48,34.5 79.6,64.16 27.24,49.05 26.69,113.85 -5.98,160.27 -19.18,26.35 -46.12,47.78 -77.61,57.28 -12.14,4.07 -24.74,7.3 -37.68,7 -37.43,-0.21 -74.85,0.21 -112.28,-0.59 -0.25,-18.03 -0.21,-36.07 -0.13,-54.06 33.14,-0.34 66.28,0.08 99.42,0.04 38.44,2.33 74.72,-23.34 90.97,-57.33 0.47,-2.21 1.32,-6.7 1.78,-8.95 6.11,-23.42 5.01,-49.94 -7.13,-71.37 -10.91,-20.58 -29.96,-35.94 -51.34,-44.68 -44.04,-8.36 -89.06,-1.74 -133.58,-4.58 0.38,-16.97 0.42,-33.95 0.38,-50.88 z"
        :fill="logoColor"
      />
    </g>
  </svg>
  ...
  <!-- Custom SVG Logo -->
  <div v-else-if="isCustomLogo && getLogoSvg" v-html="getLogoSvg" class="custom-logo-container"></div>
