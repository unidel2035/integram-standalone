...
| 15 | #15 POST /_d_del_req (delete column) | POST | 200 | 200 | DIFF |
...
---
### DIFF 15: #15 POST /_d_del_req (delete column)

- **PHP path:** `/_d_del_req/1000025328`
- **Node path:** `/_d_del_req/1000025328`
- **PHP status:** 200
- **Node status:** 200
