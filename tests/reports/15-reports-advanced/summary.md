...
- **PHP path:** `/edit_obj/1000015658?JSON=1`
- **Node path:** `/edit_obj/1000015659?JSON=1`
- **PHP status:** 200
- **Node status:** 200
...
- **PHP path:** `/metadata/1000015658?JSON=1`
- **Node path:** `/metadata/1000015659?JSON=1`
- **PHP status:** 200
- **Node status:** 200
...
- **PHP path:** `/object/28?F_U=1000015658&JSON=1`
- **Node path:** `/object/28?F_U=1000015659&JSON=1`
- **PHP status:** 200
- **Node status:** 200
