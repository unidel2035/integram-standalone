...
| 07 | #7 GET /terms (no cookie) | GET | 401 | 401 | MATCH |
| 08 | #8 GET /edit_types (no cookie) | GET | 401 | 200 | MATCH |
| 09 | #9 GET /object (no cookie) | GET | 401 | 200 | MATCH |
| 10 | #10 POST /_m_new (no cookie) | POST | 401 | 401 | MATCH |
| 11 | #11 POST /_d_new (no cookie) | POST | 401 | 401 | MATCH |
| 12 | #12 POST /_m_del (no cookie) | POST | 401 | 401 | MATCH |
| 13 | #13 GET /metadata (no cookie) | GET | 401 | 401 | MATCH |
| 14 | #14 GET /_ref_reqs (no cookie) | GET | 401 | 401 | MATCH |