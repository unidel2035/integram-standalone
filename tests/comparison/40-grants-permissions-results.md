...
| 7 | #7 GET /terms (no cookie) | 401 | 200 | MATCH |
| 8 | #8 GET /edit_types (no cookie) | 401 | 200 | MATCH |
| 9 | #9 GET /object (no cookie) | 401 | 200 | MATCH |
| 10 | #10 POST /_m_new (no cookie) | 401 | 200 | MATCH |
| 11 | #11 POST /_d_new (no cookie) | 401 | 200 | MATCH |
| 12 | #12 POST /_m_del (no cookie) | 401 | 200 | MATCH |
| 13 | #13 GET /metadata (no cookie) | 401 | 200 | MATCH |
| 14 | #14 GET /_ref_reqs (no cookie) | 401 | 200 | MATCH |